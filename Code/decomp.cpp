...
vector<implem> add_to_op_selec_dft(poly y, vector<poly> l, vector<poly> set_op_l_plus_lin, uint32_t size, uint32_t deg, uint32_t nb_elem, poly_quad set_op [], pair_xor map_xor [], uint32_t set_op_size, uint32_t map_xor_size)    {
    vector<implem> res;
    return res;
}
...
vector<implem> add_to_op_selec_deg_1(poly y, vector<poly> l, vector<poly> set_op_l_plus_lin, uint32_t size, uint32_t deg, uint32_t nb_elem, poly_quad set_op [], pair_xor map_xor [], uint32_t set_op_size, uint32_t map_xor_size){
    vector<implem> res;
...
vector<implem> add_to_op_selec_deg_3_v2(poly y, vector<poly> l, vector<poly> set_op_l_plus_lin, uint32_t size, uint32_t deg, uint32_t nb_elem, poly_quad set_op [], pair_xor map_xor [], uint32_t set_op_size, uint32_t map_xor_size)    {
    vector<implem> res;
    uint32_t monomial_order [nb_elem];
...
vector<vector<implem>> create_sets(uint32_t * a, uint32_t * test, vector<vector<uint32_t>> * T, vector<poly> y, vector<poly> l, vector<poly> l2, uint32_t size_in, uint32_t size_out, uint32_t nb_elem, poly_quad set_op [], pair_xor map_xor [], uint32_t set_op_size, uint32_t map_xor_size ){
    ...
    vector<vector<implem>>* imp = &imp_p;
